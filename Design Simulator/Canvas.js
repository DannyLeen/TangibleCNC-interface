class Canvas {
    constructor() {
      ...
      //  this.machineSize = new createVector(610, 600);
        ...
        this.outer2;
        this.geomData = [];
        this.gcodeElement = document.getElementById("gcode");
    }
...
*/
    ...
    clearSVG() {
        ...
        jscut.svg.addGeometryToSvg(this.svg, this.outer2, 90, {
            fill: 'White',
            stroke: '#000000',
            'stroke-width': '10'
        });
                ...
                for (let tempData in blockData.Instruction.data) {
                    ...
                    if (tempData == "operation") {
                        ...
                        if (this.geomData.length > 0) {
                           ...
                           // console.log(camPaths);
                            let gcode = this.cam.generateGcode(camPaths);

                            let text = document.createTextNode(gcode);
                            this.gcodeElement.appendChild(text);
                        } else {
